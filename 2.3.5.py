...
#Add your code here!
str_jacket = str(cold or windy)
print("Jacket: " + str_jacket)
str_boots = str(cold and snowy)
print("Boots: " + str_boots)
str_flip = str(hot and not(rainy))
print("Flip-Flops: " + str_flip)
str_t = str(hot and not(rainy or windy))
print("T-shirt: " + str_t)
