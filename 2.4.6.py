...
bonus_round = round(bonus, 1)
fin_avg = my_current_average + bonus_round
fin_avg = round(fin_avg, 1)
#print(fin_avg)
avg_str = str(fin_avg)
bonus_str = str(bonus_round)

print("After the " + bonus_str + " point bonus, my average is " + avg_str + ".")
